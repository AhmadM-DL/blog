...
<div class="img img--fullContainer img--14xLeading" style="background-image: url({{ site.baseurl_posts_img }}nn-decision-boundary.png);"></div>
{: .text-center}
...
![]({{ site.baseurl_posts_img }}ensembles.png)
...
![]({{ site.baseurl_posts_img }}normaility%20good%20bad.png)
...
![]({{ site.baseurl_posts_img }}total%20variance%20-%20total%20expectation.png)
